...
func main() {
	...
	router.DELETE("/api/event/:eventid/media/:id", deleteMedia)
	...
	router.POST("/api/event/:eventid/ticket", createTick)
	router.GET("/api/event/:eventid/ticket", getTicks)
	router.GET("/api/event/:eventid/ticket/:tickid", getTick)
	router.PUT("/api/event/:eventid/ticket/:tickid", editTick)
	router.DELETE("/api/event/:eventid/ticket/:tickid", deleteTick)
	...
	router.DELETE("/api/place/:placeid/review", addReview)
	router.DELETE("/api/place/:placeid/media", addMedia)
